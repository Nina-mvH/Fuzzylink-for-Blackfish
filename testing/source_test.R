# Test functionality using functions rather than library
library(tidyverse)
source("/Users/nv5842/github/fuzzylink/R/fuzzylink.R")
...
df <- fuzzylink(dfA, dfB, by = 'name', record_type = 'person',blocking.variables = 'state')
